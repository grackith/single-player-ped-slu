...
public class MeshExtrusion
{
    public class Edge
    {
        ...
        //Store if Edge is in the Front of an Extruded Mesh or Back.
        public bool isFrontEdge = false;
    }
    ...
    //Takes a Mesh, Extrude Mesh(Saved output), Matrix4x4[] extrusionMatrix, Edge[] edges, bool inverFaces?
    public static void ExtrudeMesh(Mesh srcMesh, Mesh extrudedMesh, Matrix4x4[] extrusion, Edge[] edges, bool invertFaces)
    {
        Debug.Log("Call Full Extrusion");
    ...
    public static Edge[] BuildManifoldEdges(Mesh mesh)
    {
        ...
        {
            //Remove All Shared Edges, Leaving only the Unique Edge (Boundary Edge)
