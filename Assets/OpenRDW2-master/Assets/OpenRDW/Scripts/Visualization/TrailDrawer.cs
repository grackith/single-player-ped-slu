...
public class TrailDrawer : MonoBehaviour
{
    ...
    List<Vertice> realTrailVertices = new List<Vertice>(), virtualTrailVertices = new List<Vertice>(), virtualSpaceTrailVertices = new List<Vertice>();

    public const string REAL_TRAIL_NAME = "Real Trail", VIRTUAL_TRAIL_NAME = "Virtual Trail", VIRTUAL_SPACE_TRIAL_NAME = "Virtual Space Trail";

    Transform trailParent = null, realTrail = null, virtualTrail = null, virtualSpaceTrail = null;
    Mesh realTrailMesh, virtualTrailMesh, virtualSpaceTrailMesh;
    ...
    public void BeginTrailDrawing()
    {
        ...
        if (redirectionManager.globalConfiguration.drawVirtualTrail)
        {
            Initialize(VIRTUAL_SPACE_TRIAL_NAME, globalConfiguration.realTrailColor, virtualSpaceTrailVertices, out virtualSpaceTrail, out virtualSpaceTrailMesh);
