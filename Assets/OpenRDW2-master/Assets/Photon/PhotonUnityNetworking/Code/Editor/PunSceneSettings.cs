...
#pragma warning disable 0168
                    ...
                    catch (Exception e)
                    {
                        ...
                        Debug.LogError("-- WARNING: PROJECT CLEANUP NECESSARY -- If you delete pun from   project, make sure you also clean up the Scripting define symbols from any reference to PUN like 'PHOTON_UNITY_NETWORKING ");
#endif
                    }
