...
namespace Photon.Chat.Demo
{
    ...
    ///
    /// Workflow:
    /// Create ChatClient, Connect to a server with   AppID, Authenticate the user (apply a unique name,)
    ...
    public class ChatGui : MonoBehaviour, IChatClientListener
    {
        ...
        private void SendChatMessage(string inputLine)
        {
            ...
            if (inputLine[0].Equals('\\'))
            {
                ...
                if (tokens[0].Equals("\\state"))
                {
                    ...
                    this.chatClient.SetOnlineStatus(newState, messages.ToArray()); // this is how you set   own state and (any) message
                }
        ...
        public void OnConnected()
        {
            ...
            this.chatClient.SetOnlineStatus(ChatUserStatus.Online); // You can set   online state (without a mesage).
        }
        ...
        public void OnPrivateMessage(string sender, object message, string channelName)
        {
            ...
            // you also get messages that you sent  self. in that case, the channelName is determinded by the target of   msg
